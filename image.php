...
// f		absolute path of local image starting with "/" (e.g. /images/toast.jpg)
...
define('CURRENT_DIR',			dirname(__FILE__));//dirname(__FILE__)
define('CACHE_DIR_NAME',		'/imagecache/');
define('CACHE_DIR',				CURRENT_DIR . CACHE_DIR_NAME);
define('DOCUMENT_ROOT',			'/');

// Images must be local files, so for convenience we strip the domain if it's there
$image			= preg_replace('/^(s?f|ht)tps?:\/\/[^\/]+/i', '', (string) $_GET['f']);
