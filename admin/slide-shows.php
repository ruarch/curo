...
if(isset($_POST['slide_search_btn'])){
	$search_url='slide-shows.php';
	if(isset($_POST['page'])){
...
<html lang="en">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="../media/colorbox/2/colorbox.css" />
    ...
    <?php
		if(isset($_GET['action'])){
			...
			if($action=='add-new' || $action=='edit'){
				include('includes/slide-shows.php');				
			}else{
				include('includes/list-slide-shows.php');
			}
		}else{
				include('includes/list-slide-shows.php');
			}
