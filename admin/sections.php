...
if(isset($_POST['section_search_btn'])){
	$search_url='sections.php';
	if(isset($_POST['page'])){
    ...
    <?php
		if(isset($_GET['action'])){
			...
			if($action=='add-new' || $action=='edit'){
				...
				include('includes/list-sections.php');
			}
		}else{
				include('includes/list-sections.php');
			}
...
<?php include('includes/footer.php');?>
  <?php ob_flush();?>
   ...
   <script src="js/bootstrap-wysihtml5-0.0.2.min.js"></script>
    <script src="includes/kcfinder/js/browser.js" type="text/javascript"></script>
   <script>
