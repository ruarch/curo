...
if(isset($_POST['images_search_btn'])){
	$search_url='category-images.php';
	if(isset($_POST['page'])){
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title><?php echo SITE_NAME;?> - Admin | <?php echo  ucwords($pagelabel);?></title>
    ...
    <?php
		if(isset($_GET['action'])){
			...
			if($action=='add-new' || $action=='edit'){
				include('includes/category-images.php');				
			}else{
				include('includes/list-category-images.php');
			}
		}else{
				include('includes/list-category-images.php');
			}
