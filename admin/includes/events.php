...
?>
<div class="row" > <div class="span2 pull-right"><input type="submit" name="event_btn" class="btn"  value="<?php if(@$action=='add-new'){echo 'Add';}elseif(@$action=='edit'){echo 'Update';}else{echo 'Add';}?>" /></div></div>
