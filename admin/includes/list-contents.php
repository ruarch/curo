  ...
  <?php echo  @$del_content_msg;?>
    <section id="articles">
      <div class="page-header">
        <h4 style="margin:0px">Content</h4>
      </div>
...
<br class="hidden-desktop" />
   ...
   <form method="post" name="frmaction">
      ...
      <div class="btn-group">
        ...
        <a href="contents.php" class="btn"><i class="icon-align-justify"></i> <strong>List All</strong></a>
      </div>
      </div>
      	<div class="span9">
        	
             <?php $pagination='';$q=''; if(isset($_GET['p'])){$pagination=$_GET['p'];} if(isset($_GET['q'])){$q=$_GET['q'];};get_list_content($pagination,$q);?>
