...
<?php if(isset($_GET['action'])){
			$action=$_GET['action'];
			if($action=='add-new'){
  				echo'<h4 style="margin:0px">Section Images - Add New</h4>';
			}elseif($action=='edit'){
				echo'<h4 style="margin:0px">Section Images - Edit</h4>';
				if(isset($_GET['id'])){
      ...
      <div class="tab-content">
            <div class="tab-pane active" id="home">
                  <div class="row">
                        ...
                        <label>Section:  <?php echo @$image_con_error;?></label>
						 <select name="image_con" class="span2">
                            <?php @load_section($image_con);?>
                          </select>
                        </div>
                  </div>
                  <div class="row">
